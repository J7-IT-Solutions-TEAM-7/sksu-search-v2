        ...
        <form method="POST" action="{{ route('login') }}" class="">
            ...
            <div class="flex items-center justify-between mt-4">
                <label for="remember_me"  class="flex items-center font-bold text-white drop-shadow">
                    ...
                    <a class="text-sm text-primary-100 underline hover:text-primary-200" href="{{ route('password.request') }}">
            ...
            <div class="mt-3">
                ...
                <a href="auth/google"
                    ...
                    <span class="inline-flex m-auto text-center"><img
                            ...
                            class="inline h-6 mx-0 px-auto" /> <span
