    ...
    <div class="px-4 sm:max-w-8xl mx-auto block py-2 ">
        <ul role="list" class="space-y-3 rounded-xl">
            <li class="px-6 my-2">
                ...
                <a href="{{route('travel-order')}}" class="bg-primary-500 text-white text-sm py-2 px-4 rounded-xl inline-flex items-center p-3">
                ...
                <div>
                <a href="#" class="bg-primary-500 text-white text-sm py-2 px-4 rounded-xl inline-flex items-center p-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                ...
                <ul role="list" class="space-y-3 rounded-xl ">
                    ...
                    <li class="py-4 overflow group hover:cursor-pointer rounded-md bg-white px-6 shadow"
                        ...
                        <span class="text-left mb-2 group-hover:cursor-pointer block" x-on:click="open = !open">Cash
                            Advances</span>
                        <ul role="list"
                            class="rounded-xl bg-primary-300 text-white py-2 lg:flex gap-4 md:grid-cols-5 items-center" x-cloak
                            x-show="open">
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3 capitalize">
                                <span class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Local
                                    Travel</span>
                            </li>
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3 capitalize">
                                <span
                    ...
                    <li class="py-4 overflow-hidden group hover:cursor-pointer rounded-md bg-white px-6 shadow"
                        ...
                        <ul role="list"
                            class="rounded-xl grid bg-primary-300 py-2 text-white lg:flex gap-4 md:grid-cols-5 items-center" x-cloak
                            x-show="open">
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3 capitalize">
                                <span class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Local
                                    Travel</span>
                    ...
                    <li class="py-4 overflow-hidden group hover:cursor-pointer rounded-md bg-white px-6 shadow"
                        x-data="{ open: false }">
                        <span class="text-left mb-2 group-hover:cursor-pointer block"
                            x-on:click="open = !open">Others</span>
                        <ul role="list"
                            class="rounded-xl bg-primary-300 py-2 text-white items-center" x-cloak
                            x-show="open">
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3  capitalize">
                                <span class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Individual Compensation for Salary/Wage (COS/JO)</span>
                            </li>
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3  capitalize">
                                <span
                                    class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Payroll Compensation for Salaries/Wages (COS/JO)</span>
                            </li>
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3  capitalize">
                                <span
                                    class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Utilities, Fuel, Internet, Telephone, Etc.<span class="uppercase">etc.</span></span>
                            </li>
                            <li class="overflow-hidden group hover:cursor-pointer flex rounded-md py-2 px-3  capitalize">
                                <span
                                    class="text-left group-hover:cursor-pointer hover:bg-primary-500 px-2 rounded-md">Payment to Contractors of Infrastructure Projects</span>
                            </li>
                    </li>
                </ul>
            </li>
